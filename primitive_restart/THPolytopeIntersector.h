...
#ifndef OSGUTIL_POLYTOPEINTERSECTORee
#define OSGUTIL_POLYTOPEINTERSECTOReee 1
...
class THPolytopeIntersector : public osgUtil::Intersector
{
    public:

        /** Construct a PolytopeIntersector using specified polytope in MODEL coordinates.*/
        THPolytopeIntersector(const osg::Polytope& polytope);

        /** Construct a PolytopeIntersector using specified polytope in specified coordinate frame.*/
        THPolytopeIntersector(CoordinateFrame cf, const osg::Polytope& polytope);
        ...
        THPolytopeIntersector(CoordinateFrame cf, double xMin, double yMin, double xMax, double yMax);
